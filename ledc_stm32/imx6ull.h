...
#define CCM                 ((struct CCM_REGS *)CCM_BASE)
#define IOMUX_SW_MUX		((struct IOMUX_SW_MUX_REGS *)IOMUX_SW_MUX_BASE)
#define IOMUX_SW_PAD		((struct IOMUX_SW_PAD_REGS *)IOMUX_SW_PAD_BASE)
#define GPIO1               ((struct GPIO_REGS *)GPIO1_BASE)
#endif